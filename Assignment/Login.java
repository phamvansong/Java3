...
public class Login extends javax.swing.JFrame {
    ...
    static final String url = "jdbc:sqlserver://localhost:1433;databasename=FPL_DAOTAO;integratedSecurity=true";
...
//    
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (txtUsername.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Chua nhap Username", "Error", JOptionPane.ERROR_MESSAGE);
            txtUsername.requestFocus();
            return;
        }
        if (txtPassword.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Chua nhap Password", "Error", JOptionPane.ERROR_MESSAGE);
